...
namespace StatelessCore
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("StatelessCoreType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();
